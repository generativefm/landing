...
const Index = ({ featuredGenerators = [] }) => (
  <>
    ...
    <main className="landing">
      <div className="landing__content">
        ...
        <h2 className="landing__content__subtitle">
          Ambient music generators to let you focus, sleep, or relax. Composed
          by a human and performed by computers.
        </h2>
        <a href="https://play.generative.fm" className="landing__content__link">
          Open Web Player
        </a>
      </div>
      <div className="landing__featured">
        {featuredGenerators.map(({ imageSrc, title, subtitle, href }) => (
          <a key={href} className="landing__featured__generator" href={href}>
            <img className="landing__featured__generator__img" src={imageSrc} />
